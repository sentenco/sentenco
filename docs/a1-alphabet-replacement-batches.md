# A1 alphabet picture replacement: 7 batches of 11

Order: `duck` first (confirmed watermark), then the lessons in order. Each batch is 11 pictures. For every word, the new picture is written over **every** copy listed (same file name and extension), so no lesson code changes.

Status is tracked at the bottom of this file.

## Batch 1

| # | Word | Replace these files |
|---|---|---|
| 1 | duck | `u1-l2/duck.png` |
| 2 | alligator | `u1-l1/alligator.jpg` |
| 3 | ant | `u1-l1/ant.jpg` |
| 4 | apple | `u1-l1/apple.jpg`, `u8-l1/apple.jpg` |
| 5 | ball | `u1-l1/ball.jpg`, `u10-l1/ball.jpg`, `u11-l1/ball.jpg` |
| 6 | banana | `u1-l1/banana.jpg`, `u8-l1/banana.jpg` |
| 7 | bear | `u1-l1/bear.jpg` |
| 8 | car | `u1-l1/car.avif`, `u11-l1/car.avif` |
| 9 | cat | `u1-l1/cat.jpg`, `u4-l1/cat.jpg`, `u9-l1/cat.jpg` |
| 10 | cookie | `u1-l1/cookie.webp` |
| 11 | dog | `u1-l2/dog.jpg`, `u4-l2/dog.jpg`, `u9-l1/dog.jpg` |

## Batch 2

| # | Word | Replace these files |
|---|---|---|
| 1 | doll | `u1-l2/doll.png` |
| 2 | ear | `u1-l2/ear.jpg` |
| 3 | egg | `u1-l2/egg.jpg`, `u8-l1/egg.jpg` |
| 4 | elephant | `u1-l2/elephant.jpg`, `u9-l1/elephant.jpg` |
| 5 | fish | `u1-l2/fish.avif`, `u9-l1/fish.avif` |
| 6 | flower | `u1-l2/flower.jpg` |
| 7 | frog | `u1-l2/frog.jpg` |
| 8 | gift | `u1-l3/gift.jpg` |
| 9 | goat | `u1-l3/goat.avif` |
| 10 | grapes | `u1-l3/grapes.jpg` |
| 11 | hat | `u1-l3/hat.avif` |
...
|---|---|---|
| 1 | hen | `u1-l3/hen.jpg` |
| 2 | house | `u1-l3/house.jpeg`, `u10-l1/house.jpeg` |
| 3 | icecream | `u1-l3/icecream.jpg` |
| 4 | igloo | `u1-l3/igloo.jpg` |
| 5 | insect | `u1-l3/insect2.jpg` |
| 6 | jam | `u2-l1/jam.avif` |
| 7 | jellyfish | `u2-l1/jellyfish.jpg` |
| 8 | juice | `u2-l1/juice.avif` |
| 9 | king | `u2-l1/king.jpg` |
| 10 | kite | `u2-l1/kite.jpg` |
| 11 | koala | `u2-l1/koala.avif` |

## Batch 4

| # | Word | Replace these files |
|---|---|---|
| 1 | lamp | `u2-l1/lamp.avif` |
| 2 | leaf | `u2-l1/leaf.avif` |
| 3 | lion | `u2-l1/lion.avif`, `u9-l1/lion.avif` |
| 4 | milk | `u2-l2/milk.avif` |
| 5 | monkey | `u2-l2/monkey.avif`, `u9-l1/monkey.avif` |
| 6 | moon | `u2-l2/moon.jpeg` |
| 7 | nest | `u2-l2/nest.avif` |
| 8 | nose | `u2-l2/nose.jpg` |
| 9 | nut | `u2-l2/nut.avif` |
| 10 | octopus | `u2-l2/octopus.avif` |
| 11 | orange | `u2-l2/orange.jpg` |

## Batch 5

| # | Word | Replace these files |
|---|---|---|
| 1 | owl | `u2-l2/owl.jpeg` |
| 2 | panda | `u2-l3/panda.jpg` |
| 3 | pencil | `u2-l3/pencil.jpeg` |
| 4 | pizza | `u2-l3/pizza.avif`, `u8-l1/pizza.avif` |
| 5 | quail | `u2-l3/quail.jpeg` |
| 6 | queen | `u2-l3/queen.jpg` |
| 7 | quilt | `u2-l3/quilt.avif` |
| 8 | rabbit | `u2-l3/rabbit.avif` |
| 9 | rainbow | `u2-l3/rainbow.jpg` |
| 10 | ring | `u2-l3/ring.avif` |
| 11 | sock | `u3-l1/sock.avif` |

## Batch 6

| # | Word | Replace these files |
|---|---|---|
| 1 | star | `u3-l1/star.avif` |
| 2 | sun | `u3-l1/sun.jpg` |
| 3 | tent | `u3-l1/tent.avif` |
| 4 | tiger | `u3-l1/tiger.jpg` |
| 5 | tomato | `u3-l1/tomato.jpeg` |
| 6 | ukulele | `u3-l1/ukulele.avif` |
| 7 | umbrella | `u3-l1/umbrella.avif` |
| 8 | unicorn | `u3-l1/unicorn.avif` |
| 9 | van | `u3-l2/van.avif` |
| 10 | vase | `u3-l2/vase.avif` |
| 11 | volcano | `u3-l2/volcano.jpeg` |

## Batch 7

| # | Word | Replace these files |
|---|---|---|
| 1 | watch | `u3-l2/watch.avif` |
| 2 | watermelon | `u3-l2/watermelon.avif` |
| 3 | web | `u3-l2/web.avif` |
| 4 | xray | `u3-l2/xray.avif` |
| 5 | xylophone | `u3-l2/xylophone.avif` |
| 6 | yak | `u3-l3/yak.jpeg` |
| 7 | yarn | `u3-l3/yarn.jpg` |
| 8 | yoyo | `u3-l3/yoyo.jpeg` |
| 9 | zebra | `u3-l3/zebra.avif` |
| 10 | zipper | `u3-l3/zipper.avif` |
| 11 | zoo | `u3-l3/zoo.avif` |
...
Decision (user, 2026-09-21): generate the "Hello!" picture too. It is `u1-l1/wavingkid.jpg` (A1 "Hello!" slide). A2 also uses it as the "friend" picture (Unit 2 stories, Unit 11 "see my friend"), so the child must look like a friendly, gender-neutral kid. Ask for `wavingkid.jpeg` in Downloads. The user wants the WAVING to be the focus, so a student can easily say the kid is saying hello (raised open palm with motion lines, open smiling mouth).
...
Correction (user, 2026-09-21): the 12 pictures listed above as "still look sourced" (u6-words bat/hog/log/mat, u7-objects board/crayon/book/chair/desk, u9-l1 bird/giraffe, u4-l3 pen) were GENERATED by the user. They stay. The A1 Kids picture work is closed.
