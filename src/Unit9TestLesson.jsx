...
export default function Unit9TestLesson() {
...
export const LESSON_GUIDE = [
  ...
  { stage: "HIGHLIGHT: Animal Detective", time: "~3 min", note: "Give clues about a hidden animal. Student guesses. Then switch: student gives clues and the teacher guesses." },
    ...
    // 1: Cover
    {
      ...
      body: (
        <div className="title-content">
          <span className="title-highlight"><h1 className="slide-h title-h">Unit 9 Test</h1></span>
          <p className="slide-p title-p">Let's see everything you learned about animals!</p>
        </div>
      ),
    },
      ...
      body: (
        <>
          ...
          <div className="word-row">
            ...
            <Pic src={`${IMG}/lion.avif`} label="lion" size={62} onZoom={onZoom} />
            <Pic src={`${IMG}/elephant.jpg`} label="elephant" size={62} onZoom={onZoom} />
            <Pic src={`${IMG}/monkey.avif`} label="monkey" size={62} onZoom={onZoom} />
    ...
    // 6: Animal Picture Talk
    {
      ...
      body: (
        <div className="center-col">
          ...
          <Pic src={null} label="a new zoo scene" size={110} onZoom={onZoom} />
        </div>
      ),
    },
    // 7: HIGHLIGHT Animal Detective (round 1)
    {
      stage: "HIGHLIGHT: Animal Detective",
      body: (
        <div className="center-col">
          ...
          <div className="bubble-col" style={{ maxWidth: 420 }}>
            <div className="brow">
              <div className="avatar navy">T</div>
              <div className="bubble left">It has a long neck. It is big.</div>
            </div>
      ...
      body: (
        <div className="center-col">
          <div className="bubble-col" style={{ maxWidth: 420 }}>
            <div className="brow me">
              <div className="avatar coral">S</div>
              <div className="bubble right">It says roar!</div>
            </div>
            <div className="brow">
              <div className="avatar navy">T</div>
    ...
    // 9: Final Challenge
    {
      ...
      body: (
        <div className="center-col">
          ...
          <Pic src={null} label="new animal scene" size={110} onZoom={onZoom} />
        </div>
      ),
    },
    // 10: My Unit 9 Score!
      ...
      body: (
        <div className="center-col">
          ...
          <div className="score-table">
            ...
            <div className="score-row"><span>Language</span><span>/ 4</span></div>
            <div className="score-row"><span>Sight Words</span><span>/ 4</span></div>
