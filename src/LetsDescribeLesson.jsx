...
function buildSlides({ onZoom }) {
  return [
    ...
    {
      stage: "HIGHLIGHT: Funny Body Designer!",
      body: (
        <div className="center-col">
    ...
    // 16: Great Job
    {
      ...
      body: (
        <div className="center-col">
          ...
          <p className="slide-p">Today you learned to describe with big, small, long, short, and met the -og family. See you next lesson!</p>
        </div>
      ),
    },
  ];
