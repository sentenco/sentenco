...
export default function Unit12ShowWhatYouKnowLesson() {
...
export const LESSON_GUIDE = [
  ...
  { stage: "HIGHLIGHT: A Day in My Life", time: "~6 min", note: "Give a blank sequence of 4-5 pictures. Student creates their own daily routine story, no reveal." },
...
function buildSlides({ onZoom }) {
  return [
    // 1: Cover
    {
      stage: "Unit 12 · Lesson 5",
      body: (
        <div className="title-content">
          <span className="title-highlight"><h1 className="slide-h title-h">Show What You Know!</h1></span>
          <p className="slide-p title-p">Let's talk about your day all on your own!</p>
        </div>
      ),
    },
    // 2: Warm-Up Talk
    ...
    {
      stage: "HIGHLIGHT: A Day in My Life",
      body: (
        <div className="center-col">
    ...
    // 9: Wrap-up
    {
      ...
      body: (
        <div className="center-col">
          ...
          <p className="slide-p">You used your own words to talk about your day! See you next lesson!</p>
        </div>
      ),
    },
  ];
