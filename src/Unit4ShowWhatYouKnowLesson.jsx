...
export const LESSON_GUIDE = [
  ...
  { stage: "HIGHLIGHT: My Little World", time: "~3 min", note: "Student creates a simple onscreen scene by choosing a character, age, feeling, and familiar object/animal." },
  { stage: "HIGHLIGHT: My Little World", time: "~3 min", note: "They tell the teacher about their scene using language they remember." },
...
function buildSlides({ onZoom }) {
  return [
    ...
    // 4: Feeling Situations
    {
      ...
      body: (
        <div className="center-col">
          ...
          <Pic src={null} label="child at a party" size={110} onZoom={onZoom} />
        </div>
      ),
    },
    // 4b: Feeling Situations continued
    {
      ...
      body: (
        <div className="center-col">
          ...
          <Pic src={null} label="child yawning" size={110} onZoom={onZoom} />
        </div>
      ),
    },
    // 5: What Is It?
    ...
    {
      stage: "HIGHLIGHT: My Little World",
      body: (
        <>
    ...
    // 9: Great Job
    {
      ...
      body: (
        <div className="center-col">
          ...
          <p className="slide-p">You talked all about yourself, all on your own! See you next lesson!</p>
        </div>
      ),
    },
  ];
