...
export default function Unit11ShowWhatYouKnowLesson() {
...
export const LESSON_GUIDE = [
  ...
  { stage: "HIGHLIGHT: Make a Playtime Story", time: "~6 min", note: "Give 3-4 unfamiliar cards showing a child, toy, and action. Student creates a simple story." },
...
function buildSlides({ onZoom }) {
  return [
    // 1: Cover
    {
      stage: "Unit 11 · Lesson 5",
      body: (
        <div className="title-content">
          <span className="title-highlight"><h1 className="slide-h title-h">Show What You Know!</h1></span>
          <p className="slide-p title-p">Let's talk about playtime all on your own!</p>
        </div>
      ),
    },
    // 2: Warm-Up
    ...
    // 5: Playtime Actions
    {
      ...
      body: (
        <div className="bubble-col" style={{ maxWidth: 420 }}>
          <div className="brow">
            <div className="avatar navy">T</div>
            <div className="bubble left">What is the child doing?</div>
          </div>
          <div className="brow">
            <div className="avatar navy">T</div>
    ...
    {
      stage: "HIGHLIGHT: Make a Playtime Story",
      body: (
        <div className="center-col">
    ...
    // 8: Wrap-up
    {
      ...
      body: (
        <div className="center-col">
          ...
          <p className="slide-p">You used your own words to talk about playtime! See you next lesson!</p>
        </div>
      ),
    },
  ];
