...
function buildSlides({ onZoom }) {
  return [
    ...
    // 3: Meet Sister
    {
      ...
      body: (
        <>
          ...
          <div className="wc">
          <Pic src="/curriculum/u5-family/sister.jpg" label="sister" size={154} onZoom={onZoom} />
    ...
    // 5: Meet Brother
    {
      ...
      body: (
        <>
          ...
          <div className="wc">
          <Pic src="/curriculum/u5-family/brother.jpg" label="brother" size={154} onZoom={onZoom} />
    ...
    // 11: HIGHLIGHT Family Mix-Up! (round 1)
    {
      ...
      body: (
        <>
          ...
          <Pic src="/curriculum/u5-family/sister.jpg" label="sister" size={114} onZoom={onZoom} />
    ...
    // 12: HIGHLIGHT Family Mix-Up! (round 2)
    {
      ...
      body: (
        <>
          ...
          <Pic src="/curriculum/u5-family/dad.jpg" label="dad" size={114} onZoom={onZoom} />
          <div className="bubble-col" style={{ maxWidth: 380, marginTop: 6 }}>
            <div className="brow">
              <div className="avatar navy">T</div>
    ...
    },
    {
      ...
      body: (
        <>
          <Pic src="/curriculum/u5-family/mom.jpg" label="mom" size={120} onZoom={onZoom} />
    ...
    },
    {
      ...
      body: (
        <>
          <Pic src="/curriculum/u5-family/brother.jpg" label="brother" size={120} onZoom={onZoom} />
          <div className="bubble-col" style={{ maxWidth: 380 }}>
            <div className="brow">
              <div className="avatar navy">T</div>
