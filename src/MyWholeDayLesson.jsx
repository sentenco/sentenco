...
function LetterTile({ letters, color, size = 66, fontSize = 18, onZoom }) {
...
export default function MyWholeDayLesson() {
...
export const LESSON_GUIDE = [
  ...
  { stage: "HIGHLIGHT: Build My Day", time: "~4 min", note: "Give a blank day with spaces for morning/afternoon/night. Student chooses routine cards, places them in order, tells you about their day." },
  { stage: "HIGHLIGHT: Build My Day", time: "~3 min", note: "Student continues building and narrating their day." },
...
function buildSlides({ onZoom }) {
  return [
    // 1: Cover
    {
      stage: "Unit 12 · Lesson 3",
      body: (
        <div className="title-content">
          <span className="title-highlight"><h1 className="slide-h title-h">My Whole Day!</h1></span>
          <p className="slide-p title-p">Today we tell the whole story of our day!</p>
        </div>
      ),
    },
    // 2: Warm-Up
    ...
    // 5: Phonics Time
    {
      ...
      body: (
        <>
          ...
          <div className="word-row">
            <LetterTile letters="CAT" color={FAM_COLOR.at} onZoom={onZoom} />
            <LetterTile letters="DOG" color={FAM_COLOR.og} onZoom={onZoom} />
            <LetterTile letters="PIN" color={FAM_COLOR.in} onZoom={onZoom} />
            <LetterTile letters="HOP" color={FAM_COLOR.op} onZoom={onZoom} />
            <LetterTile letters="BED" color={FAM_COLOR.ed} onZoom={onZoom} />
            <LetterTile letters="PIG" color={FAM_COLOR.ig} onZoom={onZoom} />
          </div>
        </>
      ),
    },
      ...
      body: (
        <div className="center-col">
          ...
          <div className="bubble-col" style={{ maxWidth: 380 }}>
            <div className="brow me">
              <div className="avatar coral">S</div>
              <div className="bubble right">In the morning, I wake up.</div>
            </div>
          </div>
        </div>
      ),
      ...
      body: (
        <div className="center-col">
          ...
          <div className="bubble-col" style={{ maxWidth: 380 }}>
            <div className="brow me">
              <div className="avatar coral">S</div>
              <div className="bubble right">At night, I sleep.</div>
            </div>
          </div>
        </div>
      ),
    ...
    // 9: Wrap-up
    {
      ...
      body: (
        <div className="center-col">
          ...
          <p className="slide-p">You can tell the story of your whole day! See you next lesson!</p>
        </div>
      ),
    },
  ];
