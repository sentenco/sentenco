...
export default function Unit5LetsReviewLesson() {
...
export const LESSON_GUIDE = [
  ...
  { stage: "HIGHLIGHT: Family Photo Challenge", time: "~2 min", note: "Give the student a new family photo. They become the family guide and introduce the people to the teacher." },
  { stage: "HIGHLIGHT: Family Photo Challenge", time: "~2 min", note: "Teacher makes a few intentional mistakes for the student to correct." },
...
function buildSlides({ onZoom }) {
  return [
    // 1: Cover
    {
      stage: "Unit 5 · Lesson 4",
      body: (
        <div className="title-content">
          <span className="title-highlight"><h1 className="slide-h title-h">Let's Review!</h1></span>
          <p className="slide-p title-p">Today we bring it all together: mom, dad, sister, brother, and "This is my..."</p>
        </div>
      ),
    },
    ...
    {
      stage: "HIGHLIGHT: Family Photo Challenge",
      body: (
        <>
    ...
    // 10: Great Job
    {
      ...
      body: (
        <div className="center-col">
          ...
          <p className="slide-p">You can introduce your whole family now! See you next lesson!</p>
        </div>
      ),
    },
  ];
