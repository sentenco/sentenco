...
const CLUB8 = [BASKETBALL, SOCCER, SWIMMING, DANCING, READING, COOKING, DRAWING, MUSIC_CLUB];
...
export const SOAR_A2_LESSONS = {
  ...
  "1-3": {
    ...
    slides: [
      ...
      { type: "spin", part: "B", stage: "Club Wheel", heading: "Club Wheel", items: CLUB8, instruction: [["👀", "Look at the wheel."], ["🗣️", "Say what you can do there."]], guide: "You can ___." },
      ...
      { type: "dice", part: "C", stage: "Club vs Club", heading: "Club vs Club", dice: [{ name: "Club A", items: CLUB8 }, { name: "Club B", items: CLUB8 }], instruction: [["👀", "Roll two clubs."], ["🗣️", "Say which you prefer and why."]], guide: "I prefer ___ to ___ because it is more fun." },
      { type: "dice", part: "C", stage: "Club vs Club", heading: "Club vs Club 2", dice: [{ name: "Club A", items: CLUB8 }, { name: "Club B", items: CLUB8 }], instruction: NO_HELP("Roll, choose, and say why.") },
  ...
  "1-4": {
    ...
    slides: [
      ...
      { type: "order", part: "B", stage: "Order the Project!", heading: "Order the Project!", items: [PR("choose a topic", "topic.jpg"), PR("find information", "information.jpg"), PR("make a poster", "poster.jpg"), PR("present it", "present.jpg")], instruction: ORDERQ },

      // ---- Part C: project pitch (8 min) ----
      { type: "spin", part: "C", stage: "Topic Wheel", heading: "Topic Wheel", items: [{ label: "animals", src: "/curriculum/u9-scenes/all-animals.jpg" }, PR("space", "space.jpg"), SOCCER, { label: "countries", src: "/curriculum/a2-school/geography.jpg" }, { label: "my hobby", src: "/curriculum/a2-school/art.jpg" }], instruction: [["👀", "Spin for a topic."], ["🗣️", "That's your project!"]], guide: "Our project is about ___." },
  ...
  "2-1": {
    ...
    slides: [
      ...
      { type: "spin", part: "C", stage: "What Happened Yesterday?", heading: "Story Wheel", items: [PIZZA, DOG, ICECREAM, ELEPHANT], question: "Spin and tell what happened.", instruction: [["🎡", "Spin the wheel."], ["🗣️", "Say what happened, using the picture."]], guide: "Then, he ___." },
      { type: "spin", part: "C", stage: "What Happened Yesterday?", heading: "Story Wheel 2", items: [PIZZA, DOG, ICECREAM, ELEPHANT], question: "Spin again and keep the story going.", instruction: [["🎡", "Spin the wheel."], ["🗣️", "Say what happened, using the picture."]], guide: "After that, he ___." },
  ...
  "2-2": {
    ...
    slides: [
      ...
      { type: "order", part: "C", stage: "Yesterday Reporter", heading: "Order His Day!", items: [{ ...BREAKFAST, label: "in the morning" }, { ...CAKE, label: "in the afternoon" }, { ...HOMEWORK, label: "in the evening" }], instruction: ORDERQ },
  ...
  "2-3": {
    ...
    slides: [
      ...
      { type: "spin", part: "C", stage: "Story Telephone", heading: "Story Character Wheel", items: [{ label: "Mia" }, { label: "Tom" }, { label: "Ana" }, { label: "Leo" }, { label: "Sam" }], question: "Spin for a new storyteller.", instruction: [["🎡", "Spin for a character."], ["🗣️", "Tell their yesterday story: First, Then, After that, Finally."]] },
      { type: "spin", part: "C", stage: "Story Telephone", heading: "Story Character Wheel 2", items: [{ label: "Mia" }, { label: "Tom" }, { label: "Ana" }, { label: "Leo" }, { label: "Sam" }], question: "Spin again for another storyteller.", instruction: [["🎡", "Spin for a character."], ["🗣️", "Tell their yesterday story: First, Then, After that, Finally."]] },
  ...
  "2-4": {
    ...
    slides: [
      ...
      { type: "spin", part: "C", stage: "Time Detective", heading: "Time Detective Wheel", items: [{ ...PARK, label: "go / went" }, { ...LUNCH, label: "eat / ate" }, { ...FRIEND, label: "see / saw" }, { ...HOMEWORK, label: "do / did" }], question: "Spin for a clue.", instruction: [["🔍", "Find the clue word."], ["🗣️", "Say the sentence the right way."]] },
      { type: "spin", part: "C", stage: "Time Detective", heading: "Time Detective Wheel 2", items: [{ ...PARK, label: "go / went" }, { ...LUNCH, label: "eat / ate" }, { ...FRIEND, label: "see / saw" }, { ...HOMEWORK, label: "do / did" }], question: "Spin again for another clue.", instruction: [["🔍", "Find the clue word."], ["🗣️", "Say the sentence the right way."]] },
  ...
  "2-5": {
    ...
    slides: [
      ...
      { type: "spin", part: "B", stage: "Surprise Story", heading: "Surprise Story Wheel", items: [SCHOOL, PIZZA, DOG, PICTURE, { label: "home", src: "/curriculum/u12-routines/go-home.jpg" }], question: "Spin for a picture and tell your story.", instruction: [["🎡", "Spin the wheel."], ["🗣️", "Tell a story about that picture."]] },
      { type: "spin", part: "B", stage: "Surprise Story", heading: "Surprise Story Wheel 2", items: [PARK, ICECREAM, ELEPHANT, CAKE, FRIEND], question: "Spin again for another picture.", instruction: [["🎡", "Spin the wheel."], ["🗣️", "Tell a story about that picture."]] },
  ...
  "7-2": {
    ...
    slides: [
      ...
      { type: "order", part: "C", stage: "Story Order", heading: "Story Order 5", items: STORY_RABBIT, instruction: ORDERQ, guide: ORDER2 },
      { type: "order", part: "C", stage: "Story Order", heading: "Story Order 6", items: STORY_DRAGON, instruction: ORDERQ, guide: ORDER2 },
  ...
  "7-3": {
    ...
    slides: [
      ...
      { type: "dice", part: "C", stage: "Story Dice", heading: "Story Dice 4", dice: [{ name: "Who?", items: CHARS4 }, { name: "Where?", items: PLACES2 }, { name: "The end", items: ENDINGS3 }], size: 96, instruction: [["👀", "Look at the dice."], ["🗣️", "Tell a short story."]], guide: "Once upon a time... Finally..." },
  ...
  "7-4": {
    ...
    slides: [
      ...
      { type: "dice", part: "C", stage: "Story Dice", heading: "Story Dice 5", dice: [{ name: "Who?", items: CHARS4 }, { name: "Where?", items: PLACES2 }, { name: "The end", items: ENDINGS3 }], size: 96, instruction: NO_HELP("Tell a short story.") },
  ...
  "7-5": {
    ...
    slides: [
      ...
      { type: "dice", part: "B", stage: "Story Dice", heading: "Story Podcast 5", dice: [{ name: "Who?", items: CHARS4 }, { name: "Where?", items: PLACES2 }, { name: "The end", items: ENDINGS3 }], size: 96, instruction: NO_HELP("Tell a story for the podcast.") },
      { type: "dice", part: "B", stage: "Story Dice", heading: "Story Podcast 6", dice: [{ name: "Who?", items: CHARS4 }, { name: "Where?", items: PLACES2 }, { name: "The end", items: ENDINGS3 }], size: 96, instruction: NO_HELP("Tell a story for the podcast.") },
  ...
  "8-2": {
    ...
    slides: [
      ...
      { ...ABILITYDICE, part: "C", stage: "Ability Dice", heading: "Ability Dice 5", instruction: [["👀", "Look at the dice."], ["🗣️", "Say the sentence."]], guide: "I ___ ___." },
  ...
  "8-3": {
    ...
    slides: [
      ...
      { ...REASONDICE, part: "C", stage: "Reason Dice", heading: "Reason Dice 5", instruction: [["👀", "Look at the dice."], ["🗣️", "Say the sentence."]], guide: "I like ___ because it is ___." },
  ...
  "8-4": {
    ...
    slides: [
      ...
      { ...REASONDICE, part: "C", stage: "Reason Dice", heading: "Reason Dice 4", instruction: NO_HELP("Say the sentence.") },
  ...
  "8-5": {
    ...
    slides: [
      ...
      { ...ABILITYDICE, part: "B", stage: "Ability Dice", heading: "Ability Dice 5", instruction: NO_HELP("Say the sentence.") },
  ...
  "9-1": {
    ...
    slides: [
      ...
      { type: "spin", part: "C", stage: "Feeling Wheel", heading: "Feeling Wheel 4", items: FACES8, instruction: [["👀", "Look at the wheel."], ["🗣️", "Say how you feel."]], guide: "I feel ___." },
  ...
  "10-4": {
    ...
    slides: [
      ...
      { ...HH_DISHES, part: "C", stage: "Home Helper", heading: "Home Helper 5", instruction: NO_HELP("Say a polite answer.") },
  ...
  "10-5": {
    ...
    slides: [
      ...
      { ...HH_TRASH, part: "B", stage: "Home Emergency", heading: "Home Emergency 10", instruction: NO_HELP("Say a polite answer.") },
  ...
  "11-2": {
    ...
    slides: [
      ...
      { ...WEEKDICE, part: "C", stage: "Week Dice", heading: "Week Dice 4", instruction: [["👀", "Look at the dice."], ["🗣️", "Say the plan."]], guide: "On ___, I'm going to ___." },
  ...
  "11-3": {
    ...
    slides: [
      ...
      { ...DREAMDICE, part: "C", stage: "Dream Dice", heading: "Dream Dice 4", instruction: [["👀", "Look at the die."], ["🗣️", "Say your dream."]], guide: "Someday, I'm going to ___." },
  ...
  "12-1": {
    ...
    slides: [
      ...
      { ...YESTDICE, part: "C", stage: "Yesterday Dice", heading: "Yesterday Dice 4", instruction: [["👀", "Look at the die."], ["🗣️", "Say what you did."]], guide: "Yesterday, I ___." },
