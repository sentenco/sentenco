...
function buildSlides({ onZoom }) {
  return [
        ...
        <>
          ...
          <div className="look-groups">
            <div className="look-row">
              ...
              <Pic src={`${IMG}/dog.jpg`} label="dog" size={52} onZoom={onZoom} />
              <Pic src={`${IMG}/duck.png`} label="duck" size={52} onZoom={onZoom} />
              <Pic src={`${IMG}/doll.png`} label="doll" size={52} onZoom={onZoom} />
            </div>
            <div className="look-row">
              <span className="look-letter" style={{ background: LETTER_COLOR.E }}>E</span>
              <Pic src={`${IMG}/egg.jpg`} label="egg" size={52} onZoom={onZoom} />
              <Pic src={`${IMG}/elephant.jpg`} label="elephant" size={52} onZoom={onZoom} />
              <Pic src={`${IMG}/ear.jpg`} label="ear" size={52} onZoom={onZoom} />
            </div>
            <div className="look-row">
              <span className="look-letter" style={{ background: LETTER_COLOR.F }}>F</span>
              <Pic src={`${IMG}/fish.avif`} label="fish" size={52} onZoom={onZoom} />
              <Pic src={`${IMG}/frog.jpg`} label="frog" size={52} onZoom={onZoom} />
              <Pic src={`${IMG}/flower.jpg`} label="flower" size={52} onZoom={onZoom} />
            </div>
          </div>
        </>
      ),
    ...
    // 15: Great Job
    {
      ...
      time: null,
      body: (
        <WrapUp>Today you talked about feelings, asked "How are you?", and learned Dd, Ee, and Ff.</WrapUp>
      ),
    },
  ];
}
