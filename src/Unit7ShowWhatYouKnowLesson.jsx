...
export default function Unit7ShowWhatYouKnowLesson() {
...
function buildSlides({ onZoom }) {
  return [
    // 1: Cover
    {
      stage: "Unit 7 · Lesson 5",
      body: (
        <div className="title-content">
          <span className="title-highlight"><h1 className="slide-h title-h">Show What You Know!</h1></span>
          <p className="slide-p title-p">Let's see what you can say about school, all on your own!</p>
        </div>
      ),
    },
        ...
        <>
          ...
          <div className="bubble-col" style={{ maxWidth: 420 }}>
            <div className="brow">
              ...
              <div className="bubble left">Tell me, what do you have in your bag?</div>
            </div>
          </div>
        </>
      ),
      ...
      body: (
        <>
          ...
          <div className="bubble-col" style={{ maxWidth: 420 }}>
            <div className="brow">
              <div className="avatar navy">T</div>
              <div className="bubble left">Everything is messy! What should I do?</div>
            </div>
          </div>
        </>
      ),
    ...
    // 7: Great Job
    {
      ...
      body: (
        <div className="center-col">
          ...
          <p className="slide-p">You used your own words to talk about school. See you next lesson!</p>
        </div>
      ),
    },
  ];
