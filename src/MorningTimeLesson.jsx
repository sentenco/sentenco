...
export default function MorningTimeLesson() {
...
export const LESSON_GUIDE = [
  ...
  { stage: "HIGHLIGHT: Morning Time Machine", time: "~4 min", note: "Show a morning picture and ask \"What happens next?\" Student chooses the next routine and says what happens." },
  { stage: "HIGHLIGHT: Morning Time Machine", time: "~3 min", note: "Change the starting point so the student thinks about the sequence again." },
...
function buildSlides({ onZoom }) {
  return [
    // 1: Cover
    {
      stage: "Unit 12 · Lesson 1",
      body: (
        <div className="title-content">
          <span className="title-highlight"><h1 className="slide-h title-h">Morning Time!</h1></span>
          <p className="slide-p title-p">Today we learn our morning routine!</p>
        </div>
      ),
    },
    // 2: Hello & Review
    ...
    // 4: Put It in Order (round 1)
    {
      ...
      body: (
        <div className="bubble-col" style={{ maxWidth: 420 }}>
          <div className="brow">
            <div className="avatar navy">T</div>
            <div className="bubble left">First, wake up. Then?</div>
          </div>
    ...
    // 4b: Put It in Order (round 2)
    {
      ...
      body: (
        <div className="bubble-col" style={{ maxWidth: 420 }}>
          <div className="brow">
            <div className="avatar navy">T</div>
            <div className="bubble left">First, eat. Then?</div>
          </div>
          <div className="brow me">
            <div className="avatar coral">S</div>
      ...
      body: (
        <div className="center-col">
          ...
          <div className="bubble-col" style={{ maxWidth: 380 }}>
            ...
            <div className="brow me">
              <div className="avatar coral">S</div>
              <div className="bubble right">Get up!</div>
            </div>
          </div>
        </div>
      ),
      ...
      body: (
        <div className="center-col">
          ...
          <div className="bubble-col" style={{ maxWidth: 380 }}>
            ...
            <div className="brow me">
              <div className="avatar coral">S</div>
              <div className="bubble right">Go to school!</div>
            </div>
          </div>
        </div>
      ),
    ...
    // 9: Wrap-up
    {
      ...
      body: (
        <div className="center-col">
          ...
          <p className="slide-p">You know your morning routine! See you next lesson!</p>
        </div>
      ),
    },
  ];
