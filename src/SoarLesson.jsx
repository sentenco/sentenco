...
const BLOCKS = {
  ...
  peek: PeekBlock, spin: SpinBlock, missing: MissingBlock, sprint: SprintBlock, dice: DiceBlock, town: TownBlock, dirs: DirsBlock, route: RouteBlock, shop: ShopBlock, help: HelpBlock, order: OrderBlock,
};
