...
export default function BigAndSmallLesson() {
...
export const LESSON_GUIDE = [
  ...
  { stage: "HIGHLIGHT: Animal Size Race", time: "~2 min", note: "Call \"Big!\" or \"Small!\" Student quickly finds a matching animal and says \"It's a big dog!\"" },
  { stage: "HIGHLIGHT: Animal Size Race", time: "~2 min", note: "Switch roles. Student calls the size for the teacher." },
...
function buildSlides({ onZoom }) {
  return [
    // 1: Cover
    {
      stage: "Unit 9 · Lesson 2",
      body: (
        <div className="title-content">
          <span className="title-highlight"><h1 className="slide-h title-h">Big and Small!</h1></span>
          <p className="slide-p title-p">Today we describe animals as big or small!</p>
        </div>
      ),
    },
    // 2: Animal Review
      ...
      body: (
        <div className="center-col">
          ...
          <div className="bubble-col" style={{ maxWidth: 380 }}>
            <div className="brow me">
              <div className="avatar coral">S</div>
              <div className="bubble right">It's a big dog!</div>
            </div>
          </div>
        </div>
      ),
      ...
      body: (
        <div className="center-col">
          ...
          <div className="word-row">
            ...
            <Pic src={`${IMG}/cat.jpg`} label="cat" size={60} onZoom={onZoom} />
          </div>
          <div className="bubble-col" style={{ maxWidth: 380 }}>
            <div className="brow">
    ...
    // 10: Wrap-up
    {
      ...
      body: (
        <div className="center-col">
          ...
          <p className="slide-p">You can say big and small! See you next lesson!</p>
        </div>
      ),
    },
  ];
