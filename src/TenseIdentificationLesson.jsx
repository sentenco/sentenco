...
.tid-brand { display: flex; align-items: center; gap: 0; font-family: 'Fraunces', serif; font-weight: 700; font-size: 17px; color: #fff; }
.tid-brand-logo { height: 22px; width: auto; margin-right: -2px; }
