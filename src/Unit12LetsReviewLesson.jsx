...
export default function Unit12LetsReviewLesson() {
...
export const LESSON_GUIDE = [
  ...
  { stage: "HIGHLIGHT: Mixed-Up Day", time: "~4 min", note: "Give a mixed-up daily routine. Student finds the mistakes and fixes the order." },
  { stage: "HIGHLIGHT: Mixed-Up Day", time: "~3 min", note: "After fixing it, student tells the story from beginning to end." },
...
function buildSlides({ onZoom }) {
  return [
    // 1: Cover
    {
      stage: "Unit 12 · Lesson 4",
      body: (
        <div className="title-content">
          <span className="title-highlight"><h1 className="slide-h title-h">Let's Review!</h1></span>
          <p className="slide-p title-p">Today we bring it all together: our whole day and cumulative phonics.</p>
        </div>
      ),
    },
    // 2: Routine Warm-Up
    ...
    // 8: Phonics Challenge
    {
      ...
      body: (
        <>
          ...
          <div className="word-row">
            <LetterTile letters="BAT" color={FAM_COLOR.at} onZoom={onZoom} />
            <LetterTile letters="LOG" color={FAM_COLOR.og} onZoom={onZoom} />
            <LetterTile letters="WIN" color={FAM_COLOR.in} onZoom={onZoom} />
    ...
    // 9: Wrap-up
    {
      ...
      body: (
        <div className="center-col">
          ...
          <p className="slide-p">You know your whole day and all your phonics! See you next lesson!</p>
        </div>
      ),
    },
  ];
