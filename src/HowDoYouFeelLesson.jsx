...
function buildSlides({ onZoom }) {
  return [
    ...
    // 4: Meet Pen
    {
      ...
      body: (
        <>
          ...
          <div className="wc">
          <Pic src="/curriculum/u4-l3/pen.png" label="pen" size={148} onZoom={onZoom} />
    ...
    // 6: Feelings & Say (round 1)
    {
      ...
      body: (
        <>
          ...
          <EmotionTile size={76} name="Angry" onZoom={onZoom} />
    ...
    },
    {
      ...
      body: (
        <>
        <EmotionTile name="Tired" size={82} onZoom={onZoom} />
          <div className="bubble-col" style={{ maxWidth: 380 }}>
            <div className="brow">
              <div className="avatar navy">T</div>
              <div className="bubble left">How do you feel?</div>
    ...
    },
    {
      ...
      body: (
        <>
        <EmotionTile name="Sad" size={82} onZoom={onZoom} />
          <div className="bubble-col" style={{ maxWidth: 380 }}>
            <div className="brow">
              <div className="avatar navy">T</div>
              <div className="bubble left">How do you feel?</div>
