...
export default function AnimalFriendsLesson() {
...
export const LESSON_GUIDE = [
  ...
  { stage: "HIGHLIGHT: Mystery Animal", time: "~2 min", note: "Give clues about a hidden animal: \"It says meow.\" \"It has four legs.\" Student guesses." },
  { stage: "HIGHLIGHT: Mystery Animal", time: "~2 min", note: "Switch roles. Student gives clues for the teacher to guess." },
...
function buildSlides({ onZoom }) {
  return [
    // 1: Cover
    {
      stage: "Unit 9 · Lesson 1",
      body: (
        <div className="title-content">
          <span className="title-highlight"><h1 className="slide-h title-h">Animal Friends!</h1></span>
          <p className="slide-p title-p">Today we meet cat, dog, bird, and fish!</p>
        </div>
      ),
    },
    ...
    {
      stage: "HIGHLIGHT: Mystery Animal",
      body: (
        <div className="center-col">
          ...
          <div className="bubble-col" style={{ maxWidth: 420 }}>
            <div className="brow">
              <div className="avatar navy">T</div>
              <div className="bubble left">It says meow. It has four legs.</div>
            </div>
            <div className="brow me">
              <div className="avatar coral">S</div>
              <div className="bubble right">It's a cat!</div>
      ...
      body: (
        <div className="center-col">
          ...
          <div className="bubble-col" style={{ maxWidth: 420 }}>
            <div className="brow me">
              <div className="avatar coral">S</div>
              <div className="bubble right">It says woof!</div>
            </div>
            <div className="brow">
              <div className="avatar navy">T</div>
    ...
    // 10: Wrap-up
    {
      ...
      body: (
        <div className="center-col">
          ...
          <p className="slide-p">You know cat, dog, bird, and fish! See you next lesson!</p>
        </div>
      ),
    },
  ];
