...
function PredictSlide({ lesson }) {
  ...
  return (
    <div className="rcl-slide">
      <span className="rcl-eyebrow">Think About It</span>
      <h3 className="rcl-h">{left} <span className="rcl-vs">vs</span> {right}</h3>
      <p className="rcl-compare-note">What's the difference? Take a guess before we explain.</p>
    </div>
  );
}
...
function GuidedSlide({ lesson, index }) {
  ...
  return (
    <div className="rcl-slide rcl-slide--part">
      <h3 className="rcl-h">Guided practice{totalChunks > 1 ? ` (${index + 1} of ${totalChunks})` : ""}</h3>
      ...
      <div className="rcl-stage">
        <div className="rcl-deck">
          <div className="rcl-deck-header">
            <span className="rcl-brand"><img src="/logo-sentenco.png" alt="" className="rcl-brand-logo" />entenco</span>
