...
export default function ThisIsMeLesson() {
...
export const LESSON_GUIDE = [
  ...
  { stage: "HIGHLIGHT: Me & My Cat", time: "~2 min", note: "Create a simple onscreen character scene. Student chooses a character and a cat, then makes simple statements." },
  { stage: "HIGHLIGHT: Me & My Cat", time: "~2 min", note: "Teacher reacts to and expands the student's answers with a second round." },
...
function buildSlides({ onZoom }) {
  return [
    // 1: Cover
    {
      stage: "Unit 4 · Lesson 1",
      body: (
        <div className="title-content">
          <span className="title-highlight"><h1 className="slide-h title-h">This Is Me!</h1></span>
          <p className="slide-p title-p">Today we learn to say "I am..." and meet a new word: cat!</p>
        ...
        <>
          ...
          <div className="bubble-col" style={{ maxWidth: 420 }}>
            <div className="brow">
              ...
              <div className="bubble left">Hi! What's your name?</div>
            </div>
      ...
      body: (
        <>
          ...
          <div className="bubble-col" style={{ maxWidth: 420, marginBottom: 6 }}>
            <div className="brow">
              <div className="avatar navy">T</div>
              <div className="bubble left">I am happy!</div>
            </div>
          </div>
      ...
      body: (
        <div className="center-col">
          ...
          <div className="letter-row">
            <LetterTile letters="C" color={SPELL_COLOR.C} onZoom={onZoom} />
    ...
    // 14: Great Job
    {
      ...
      body: (
        <div className="center-col">
          ...
          <p className="slide-p">Today you learned to say "I am..." and met the word cat. See you next lesson!</p>
        </div>
      ),
    },
  ];
