...
export default function Unit11TestLesson() {
...
export const LESSON_GUIDE = [
  ...
  { stage: "HIGHLIGHT: My Playtime Challenge", time: "~5 min", note: "Give a new playtime scene. Student explains what they see and what they can do." },
...
function buildSlides({ onZoom }) {
  return [
    // 1: Cover
    {
      ...
      body: (
        <div className="title-content">
          <span className="title-highlight"><h1 className="slide-h title-h">Unit 11 Test</h1></span>
          <p className="slide-p title-p">Let's see everything you learned about toys and play!</p>
        </div>
      ),
    },
    // 2: Friendly Start
    ...
    {
      stage: "HIGHLIGHT: My Playtime Challenge",
      body: (
        <div className="center-col">
      ...
      body: (
        <div className="center-col">
          ...
          <div className="score-table">
            ...
            <div className="score-row"><span>Speaking</span><span>/ 4</span></div>
            <div className="score-row"><span>Actions</span><span>/ 4</span></div>
