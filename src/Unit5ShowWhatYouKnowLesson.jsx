    ...
    // 5: Family Detective
    {
      ...
      body: (
        <div className="center-col">
          ...
          <Pic src="/curriculum/u5-family/family-scene.jpg" label="unknown family scene" size={181} onZoom={onZoom} />
        </div>
      ),
    },
    {
      ...
      body: (
        <div className="center-col">
        <Pic src="/curriculum/u5-family/family-scene.jpg" label="family photo" size={181} onZoom={onZoom} />
        </div>
      ),
    },
