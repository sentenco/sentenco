...
export default function PlaytimeFunLesson() {
...
export const LESSON_GUIDE = [
  ...
  { stage: "HIGHLIGHT: Freeze!", time: "~4 min", note: "Say an action and the student performs it. Suddenly say \"Freeze!\" Ask \"What are you doing?\"" },
  { stage: "HIGHLIGHT: Freeze!", time: "~3 min", note: "Repeat with a different action." },
...
function buildSlides({ onZoom }) {
  return [
    // 1: Cover
    {
      stage: "Unit 11 · Lesson 3",
      body: (
        <div className="title-content">
          <span className="title-highlight"><h1 className="slide-h title-h">Playtime Fun!</h1></span>
          <p className="slide-p title-p">Today we learn run, jump, throw, and kick!</p>
        </div>
      ),
    },
    // 2: Playtime Warm-Up
      ...
      body: (
        <div className="center-col">
          ...
          <div className="bubble-col" style={{ maxWidth: 380 }}>
            <div className="brow me">
              <div className="avatar coral">S</div>
              <div className="bubble right">I throw the ball!</div>
            </div>
          </div>
        </div>
      ),
      ...
      body: (
        <div className="center-col">
          ...
          <div className="bubble-col" style={{ maxWidth: 420 }}>
            ...
            <div className="brow me">
              <div className="avatar coral">S</div>
              <div className="bubble right">I jump!</div>
            </div>
          </div>
        </div>
      ),
      ...
      body: (
        <div className="center-col">
          <div className="bubble-col" style={{ maxWidth: 420 }}>
            ...
            <div className="brow me">
              <div className="avatar coral">S</div>
              <div className="bubble right">I run!</div>
            </div>
          </div>
        </div>
      ),
    ...
    // 9: Wrap-up
    {
      ...
      body: (
        <div className="center-col">
          ...
          <p className="slide-p">You can run, jump, throw, and kick! See you next lesson!</p>
        </div>
      ),
    },
  ];
...
.action-chip {
  ...
  padding: 14px 28px; border-radius: 18px; cursor: zoom-in;
