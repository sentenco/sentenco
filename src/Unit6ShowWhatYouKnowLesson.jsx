...
export const LESSON_GUIDE = [
  ...
  { stage: "HIGHLIGHT: You're the Teacher!", time: "~2 min", note: "Student becomes the teacher, choosing what to ask or show. No reveal: let the student control the exchange." },
  { stage: "HIGHLIGHT: You're the Teacher!", time: "~2 min", note: "Teacher intentionally makes a few funny mistakes for the student to correct." },
    ...
    // 10: Great Job
    {
      ...
      body: (
        <div className="center-col">
          ...
          <p className="slide-p">You described a whole person all on your own! See you next lesson!</p>
        </div>
      ),
    },
  ];
