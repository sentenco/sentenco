...
export default function AroundTheHouseLesson() {
...
export const LESSON_GUIDE = [
  ...
  { stage: "HIGHLIGHT: House Detective", time: "~2 min", note: "Give clues about a hidden room: \"You sleep here.\" Student guesses \"Bedroom!\"" },
  { stage: "HIGHLIGHT: House Detective", time: "~2 min", note: "Switch roles. Student gives clues for the teacher." },
...
function buildSlides({ onZoom }) {
  return [
    // 1: Cover
    {
      stage: "Unit 10 · Lesson 1",
      body: (
        <div className="title-content">
          <span className="title-highlight"><h1 className="slide-h title-h">Around the House!</h1></span>
          <p className="slide-p title-p">Today we learn rooms and the letters "ed"!</p>
        </div>
      ),
    },
    ...
    // 4b: Room Hunt (round 2)
    {
      ...
      body: (
        <div className="bubble-col" style={{ maxWidth: 420 }}>
          <div className="brow">
            <div className="avatar navy">T</div>
            <div className="bubble left">Where is the bedroom?</div>
          </div>
          <div className="brow me">
            <div className="avatar coral">S</div>
            <div className="bubble right">Here it is!</div>
    ...
    // 5: Meet the -ed Family
    {
      ...
      body: (
        <div className="center-col">
          ...
          <div className="row">
            <LetterTile letters="E" color={BLEND_COLOR} onZoom={onZoom} />
            <LetterTile letters="D" color={BLEND_COLOR} onZoom={onZoom} />
          </div>
        </div>
      ),
    },
    // 6: -ed blending
    {
      ...
      body: (
        <div className="center-col" style={{ gap: 10 }}>
          ...
          <BlendRow parts={["B", "ED"]} result="bed" onZoom={onZoom} />
          <BlendRow parts={["F", "ED"]} result="fed" onZoom={onZoom} />
          <BlendRow parts={["L", "ED"]} result="led" onZoom={onZoom} />
        </div>
      ),
    },
    // 7: Room or Word?
    ...
    {
      stage: "HIGHLIGHT: House Detective",
      body: (
        <div className="center-col">
          ...
          <div className="bubble-col" style={{ maxWidth: 420 }}>
            <div className="brow">
              <div className="avatar navy">T</div>
              <div className="bubble left">You sleep here.</div>
            </div>
            <div className="brow me">
              <div className="avatar coral">S</div>
              <div className="bubble right">Bedroom!</div>
            </div>
            <div className="brow">
              <div className="avatar navy">T</div>
              <div className="bubble left">You cook here.</div>
            </div>
            <div className="brow me">
              <div className="avatar coral">S</div>
      ...
      body: (
        <div className="center-col">
          ...
          <div className="bubble-col" style={{ maxWidth: 420 }}>
            <div className="brow me">
              <div className="avatar coral">S</div>
              <div className="bubble right">You watch TV here.</div>
            </div>
            <div className="brow">
              <div className="avatar navy">T</div>
              <div className="bubble left">Is it the living room?</div>
            </div>
            <div className="brow me">
              <div className="avatar coral">S</div>
              <div className="bubble right">You wash here.</div>
            </div>
            <div className="brow">
              <div className="avatar navy">T</div>
              <div className="bubble left">Is it the bathroom?</div>
            </div>
          </div>
        </div>
      ),
    ...
    // 11: Wrap-up
    {
      ...
      body: (
        <div className="center-col">
          ...
          <p className="slide-p">You know the rooms and -ed words! See you next lesson!</p>
        </div>
      ),
    },
  ];
