...
export default function MyFavoriteRoomLesson() {
...
export const LESSON_GUIDE = [
  ...
  { stage: "HIGHLIGHT: Design My Dream Room!", time: "~4 min", note: "Student creates a simple dream room by choosing furniture/objects and placing them inside." },
...
function buildSlides({ onZoom }) {
  return [
    // 1: Cover
    {
      stage: "Unit 10 · Lesson 3",
      body: (
        <div className="title-content">
          <span className="title-highlight"><h1 className="slide-h title-h">My Favorite Room!</h1></span>
          <p className="slide-p title-p">Today we talk about our favorite room in the house!</p>
        </div>
      ),
    },
    // 2: House Warm-Up
        ...
        <div className="center-col">
          ...
          <div className="bubble-col" style={{ maxWidth: 380 }}>
            <div className="brow">
              ...
              <div className="bubble left">What rooms do you see?</div>
            </div>
          </div>
        </div>
      ),
      ...
      body: (
        <div className="center-col">
          ...
          <div className="word-row">
            ...
            <Pic src="/curriculum/u10-rooms/bed.jpg" label="bed" size={80} onZoom={onZoom} />
          </div>
        </div>
      ),
    },
    ...
    {
      stage: "HIGHLIGHT: Design My Dream Room!",
      body: (
        <div className="center-col">
          <span className="title-highlight"><h2 className="slide-h sub">🎨 Design My Dream Room!</h2></span>
          <div className="word-row">
            <Pic src="/curriculum/u10-rooms/bed.jpg" label="bed" size={70} onZoom={onZoom} />
      ...
      body: (
        <div className="center-col">
          ...
          <div className="bubble-col" style={{ maxWidth: 380 }}>
            <div className="brow">
              <div className="avatar navy">T</div>
              <div className="bubble left">Why do you like it?</div>
            </div>
          </div>
        </div>
      ),
    ...
    // 10: Wrap-up
    {
      ...
      body: (
        <div className="center-col">
          ...
          <p className="slide-p">You talked about your favorite room! See you next lesson!</p>
        </div>
      ),
    },
  ];
